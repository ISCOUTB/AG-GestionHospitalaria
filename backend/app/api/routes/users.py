...
from app.api.deps import SessionDep, CurrentUser, Admin
...
@router.get("/")
async def get_users(
    current_user: Admin, db: SessionDep, rol: bool = False, active: bool = True
...
async def create_user(
    current_user: Admin, db: SessionDep, new_user: schemas.UserCreate
) -> dict:
    """
...
async def update_basic_user(
    current_user: CurrentUser, db: SessionDep, updated_info: schemas.UserUpdate
) -> dict:
    """
...
async def delete_user(
    num_document: str, rol: schemas.Roles, current_user: Admin, db: SessionDep
) -> dict:
    """
