...
async def get_doctor(
    num_document: str, current_user: Admin, db: SessionDep, active: bool = True
) -> schemas.DoctorAll:
    """
...
async def get_speciality_doctor(
    speciality: str, current_user: Admin, db: SessionDep, active: bool = True
) -> list[schemas.DoctorAll]:
    """
...
async def delete_speciality(
    num_document: str, current_user: Admin, db: SessionDep, speciality_name: str
) -> dict:
    """
