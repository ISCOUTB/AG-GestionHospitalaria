...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('user_roles_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("num_document", sa.TEXT(), autoincrement=False, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["num_document"],
            ["users_info.num_document"],
            name="fk_users_rol_number_document",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type_doc_responsable", sa.TEXT(), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "relationship_responsable", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["patient_id"],
            ["user_roles.id"],
            name="fk_patient_info_patient_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('specialities_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["doctor_id"],
            ["user_roles.id"],
            name="fk_doctor_specialities_doctor_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["speciality_id"],
            ["specialities.id"],
            name="fk_doctor_specialities_speciality_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name="pk_doctor_specialities"),
        sa.UniqueConstraint(
            "doctor_id", "speciality_id", name="unique_doctor_speciality"
        ),
    )
    op.create_table(
        "hospitalizations",
        ...
        sa.ForeignKeyConstraint(
            ["id_doctor"],
            ["user_roles.id"],
            name="fk_hospitalizations_id_doctor",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["id_patient"],
            ["user_roles.id"],
            name="fk_hospitalizations_id_patient",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id_doctor"],
            ["user_roles.id"],
            name="fk_medical_consults_id_doctor",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["id_patient"],
            ["user_roles.id"],
            name="fk_medical_consults_id_patient",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
