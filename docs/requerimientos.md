...
<!-- ¿Será que le agregamos a la base de datos de los registros las horas? Veo que se puede hacer de manera sencilla, pero no sabría cómo manejar muy bien las gráficas luego -->
...
<!-- - REQ-006.5: El sistema debe definir el conjunto específicos de permisos para cada rol de usuario. -->
...
<!-- ¿Utilizaremos bases de datos de series temporales para los registros? Como `questdb` que utiliza SQL. Puede ser útil para el registro de las camas, etc  -->
...
<!-- - REQ-008.6: El sistema debe implementar medidas de seguridad para proteger datos sensibles de los usuarios. -->
...
<!-- No sé cómo sea el formato, pero así puede ser -->
